  ...
  <section id="about-section" class="about-section section theme-bg-light">
    ...
    <div class="container">
      ...
      <div class="section-intro single-col-max mx-auto mb-4">
        ...
        Las charlas se transmitirán por las plataformas Zoom, <a target="_blank" href="https://www.youtube.com/channel/UCIREVPQo9SrJvhgWOTfVgDA">Youtube</a>  y 
      ...
      <div class="benefits-list text-center">
        ...
        <li><i class="fas fa-check-circle mr-2"></i> Concurso de logo de la EPCC-UNSA <a href="https://bit.ly/3BU2zcI" target="_blank">(bases)</a></li>        </ul>
      </div>
      <!--//benefits-list-->
