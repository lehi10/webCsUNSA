			...
			<div class="row py-lg-5">
				<div class="col-12 col-lg-7 h-100">
					<div class="desc">
						...
						<a class="btn btn-ghost" href="https://forms.gle/9iSUb9FBpigLQMyo6" target="_blank">Registrarse con Google Forms</a>
						<a class="btn btn-ghost" href="https://www.facebook.com/epcc.unsa" target="_blank">Transmisión via Facebook</a>
					</div><!--//desc-->
				</div><!--//col-->
				<div class="col-12 col-lg-4 offset-lg-1 position-relative h-100 mt-5 mt-lg-0">
					<div class="figures-holder">
						<div class="figure figure-1"><img class="shadow" src="/images/venue/venue-7.jpeg" alt=""></div>
